...
function compare() {
    return __awaiter(this, void 0, void 0, function () {
        var hashAmounts, trInfo, transaction, trans, _loop_1, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    trans = [];
                    _loop_1 = function (i) {
                        var _b, trigger_info, internal_transactions, tokenTransferInfo, internalTransactions, tokenTransfer;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [4 /*yield*/, axios_1.default.get("https://apilist.tronscan.org/api/transaction-info?hash=" + hash[i])];
                                case 1:
                                    trInfo = _c.sent();
                                    _b = trInfo.data, trigger_info = _b.trigger_info, internal_transactions = _b.internal_transactions, tokenTransferInfo = _b.tokenTransferInfo;
                                    if (trigger_info.parameter._amount) {
                                        ...
                                        internalTransactions.forEach(function (items) {
                                            !hashAmounts[hash[i]].token_info && items.forEach(function (transactionData) {
                                        ...
                                        tokenTransfer = Object.values(tokenTransferInfo);
                                    ...
                                    transaction[i] = {
                                        ...
                                        token_info: 'WDX',
                                        amount_str: new bignumber_js_1.default(trInfo.data.tokenTransferInfo.amount_str).shiftedBy(-18).toString(),
                                    };
                                    return [2 /*return*/];
                            }
                        });
                ...
                case 3:
                    i++;
                    return [3 /*break*/, 1];
                case 4: return [4 /*yield*/, trans.concat(transaction)];
                case 5:
                    trans = _a.sent();
