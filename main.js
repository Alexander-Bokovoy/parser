...
var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    var versionTransfer, addressTransfer, totalTransfer, versionTransaction, addressTransaction, totalTransaction, contrType, i, types, data, _a, data, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _c.label = 1;
            case 1:
                if (!(i < address.length)) return [3 /*break*/, 9];
            ...
            case 8:
                i++;
                return [3 /*break*/, 1];
            case 9: return [4 /*yield*/, parse_1.getTransaction(addressTransaction, totalTransaction, versionTransaction, contrType)];
            case 10:
                _c.sent();
