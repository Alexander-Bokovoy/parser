...
exports.getMessageHash = exports.wsProviders = void 0;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    signData.push(20);
                    signData.push('WQT');
                    web3 = new Web3(exports.wsProviders.bsc);
                    return [4 /*yield*/, web3.eth.accounts.sign((_a = web3.utils).soliditySha3.apply(_a, signData), '95174aa38065df0b8cdb186ba31ab80c08891aafdd0fbd0f9cdaab35bc17e1f5')];
                case 1:
                    messageHash = (_b.sent()).messageHash;
                    console.log(JSON.stringify(signData));
                    console.log(messageHash);
                    return [2 /*return*/, messageHash];
            }
        });
    });
}
